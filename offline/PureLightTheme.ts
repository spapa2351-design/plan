...
// import i18n from 'touchclass/srci18n/i18n';
...
export const PureLightTheme = (lang: string) =>
  createTheme({
    // direction: i18n.dir(),
    colors: {
      gradients: {
      ...
      MuiTableRow: {
        styleOverrides: {
          head: {
            ...
            borderTop: `1px solid ${colors.alpha.black[10]}`,
      ...
      MuiTableCell: {
        styleOverrides: {
          root: {
            ...
            fontSize: 14,
            paddingLeft: dimensions.tableCell.pl,
            paddingRight: dimensions.tableCell.pr
          },
          head: {
            textTransform: 'capitalize',
            fontSize: 13,
    ...
    typography: {
      fontFamily:
        '"Pretendard", "Roboto", "Inter", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji"',
      h1: {
        fontWeight: 700,
        fontSize: 35
      },
